...
extern void glob_interrupt_disable(void);
extern void glob_interrupt_enable(void);
extern void eclic_set_nlbits(uint8_t nlbits);
extern void eclic_irq_enable(uint32_t source, uint8_t lvl_abs, uint8_t priority);
